    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('http://localhost:5000/api/operations', {
                doc_type: 'receipt',
                source_location_id: null, // Vendor (external)
                destination_location_id: destinationId || 1, // Defaulting to 1 for MVP
                items
            });
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p className="text-coolgrey text-sm">Receive incoming goods from vendors into the warehouse.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
                <div>
                    ...
                    <input 
                        type="number" 
                        required 
                        className="w-full sm:w-1/2 border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-green-500"
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-center border-b pb-2">
                        <h3 className="text-lg font-semibold text-gray-800">Received Products</h3>
                        <button 
                            type="button" 
